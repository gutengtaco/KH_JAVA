...
public class ObjectRun {
	...
	public static void main(String[] args) {
		...
		/*
		// 1. 기본생성자를 통해서 객체를 생성 후, setter 메소드를 이용해서 매번 값을 각 필드에 대입
		...
		*/
		...
		// Book 객체를 생성하기 전에 일단 선언만 하고 null 로 임의로 채워넣음 (아직 어딜 가리킬지 모르니깐)
		Book bk1 = null;
		Book bk2 = null;
		Book bk3 = null;
		...
		// 3 개의 도서 정보를 입력받아서 각 객체에 초기화
		// 입력 시에는 어찌되었든 꼼수를 좀 써서 반복이 가능하긴 함!
		...
		/*
		 * 책을 관리하는 역할에는 충실함
		 * 코드 작성 시 제한이 좀 있음 => 반복문을 제대로 활용 불가, 책 객체들끼리 따로 노는 느낌
		 */
